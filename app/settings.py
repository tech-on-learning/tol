...
STATIC_ROOT = '/home/akolumxn/akoladcreations_website_cdn/static/' if not DEBUG else BASE_DIR / 'cdn/static/'
MEDIA_ROOT = '/home/akolumxn/akoladcreations_website_cdn/media/' if not DEBUG else BASE_DIR / 'cdn/media/'
